...
<a href="0_logout.php"><img id="exit" src="img\exit.png"></a>
     ...
     <div id="alert">
        ...
        <h4 class="alert alert-success">使用 金錢 或是 體力 進行採收 ?</h4>
            &nbsp;<a href='harvest.php?a=1'>金錢</a>(-50)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href='harvest.php?a=2'>體力</a>(-1)
        <br/>
        <img id="a1" src="img\a1.png" width="100" height="100">
        <br/>
        <p>
        &nbsp;&nbsp;<a class="btn btn-danger" href="1_main.php">返回</a>
        </p>
        </div>
    </div>
